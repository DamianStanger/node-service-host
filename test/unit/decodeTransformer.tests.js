...
describe("decodeTransformer", () => {
  it("should do nothing if there is no payload", done => {
  ...
  it("should do nothing if the payload is an object", done => {
  ...
  it("should do nothing if the payload is a none base64 encoded string", done => {
  ...
  it("should decode the payload to an object from a base 64 encoded string", done => {
